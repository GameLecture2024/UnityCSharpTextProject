...
namespace 다형성
{
    class Worker // 동물들을 케어해주는 기능  동물이 100개면 ?
    {
        ...
        {
            // 동물은 각자 동물이면서, 호랑이 일수도 있고, 독수리 일수도 있고, 상어 일수도 있습니다.

            // (Animal -> 각자의 클래스 변환)
            // as 키워드, is 키워드

            // is 앞의 데이터 타입과 is 뒤의 데이터 타입이 같으면 True 반환, 다르면 false 반환
